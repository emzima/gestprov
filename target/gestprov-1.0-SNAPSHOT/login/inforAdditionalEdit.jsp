<%-- 
    Document   : inforAdditionalEdit
    Created on : 13 ene. 2022, 16:56:37
    Author     : gerencia
...
<main>
    <form method="POST" action="/Login/inforAdditionalEdit">
        <!--inicio de contenedor formulario--> 
        <div class="container">
            <article class="tituloform">
                <h3 style="text-align: center">Información de la empresa</h3>
                <h4 style="text-align: center">Editar datos respecto a las condiciones ante el IVA e Ingresos y otros</h4>
            </article>
            <%  
...
%>
            <section class="row">
                <div class="col">
                    <div class="input-group mb-3">
                        ...
                        <input list="datalistStatusIva" name="statusIVA" style="background-color: #ffffff;" class="form-control" value="<%= information.getStatusIVA() %>" aria-label="Situación ante el IVA" aria-describedby="statusIVA" required/>
            ...
            <section class="row">
                <div class="col">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="statusING" style="background-color: #ffffff;" class="form-control" value="<%= information.getStatusIncome() %>" aria-label="Condición frente a retenciones" aria-describedby="statusING" required/>
                    </div>
                </div>
            </section>
            <section class="row">
                <div class="col">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="typeActivity" style="background-color: #ffffff;" class="form-control" value="<%= information.getTypeActivity() %>" aria-label="Tipo de actividad" aria-describedby="typeActivity" required/>
                    </div>
                </div>
            </section>
            <section class="row">
                <div class="col">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" name="dateStart" style="background-color: #ffffff;" class="form-control" value="<%= information.getDateStart() %>" aria-label="Fecha de inicio de actividad" aria-describedby="dateStart" required/>
                    </div>
                </div>
            </section>
            <section class="row">
                <div class="col">
                    <div class="form-floating">
                        <textarea name="descriptionActivity" class="form-control" style="background-color: #ffffff; height:150px" aria-label="Descripción de la actividad" aria-describedby="descriptionActivity" required><%= information.getDescriptionActivity() %></textarea>
            ...
            <section class="row">
                ...
                <div class="col">
                    <div class="d-grid gap-2">
                        <button type="submit" formaction="/Login/inforAdditional" class="btn btn-warning" id="borrado">Descartar cambios</button>
                    </div>
                </div>
            </section>
        </div>
