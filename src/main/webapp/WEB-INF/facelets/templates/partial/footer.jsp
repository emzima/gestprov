                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-around" id="navbarText">
                        <ul class="navbar-nav me-md-center mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a href="/Views/registration" class="nav-link">Alta de cliente</a>
                            </li>
                            <li class="nav-item">
                                <a href="/Views/contacts" class="nav-link">Como funciona</a>
                            </li>
<!--                            <li class="nav-item">
                                <a href="/Views/contacts" class="nav-link">Contactenos</a>
                            </li>-->
                            <li class="nav-item">
                                <a href="/Views/aboutus" class="nav-link">Quienes somos</a>
                            </li>
<!--                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="/Views/login" class="nav-link">Ingreso de usuario</a>
                            </li>
                        </ul>
                    </div>
                </div>
